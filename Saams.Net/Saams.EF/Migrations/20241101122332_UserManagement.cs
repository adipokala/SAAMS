        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GraceEntryTime = table.Column<TimeSpan>(type: "interval", nullable: false),
                    ExitLunch = table.Column<TimeSpan>(type: "interval", nullable: false),
                    EntryLunch = table.Column<TimeSpan>(type: "interval", nullable: false),
                    ExitTime = table.Column<TimeSpan>(type: "interval", nullable: false),
                    GraceExitTime = table.Column<TimeSpan>(type: "interval", nullable: false),
                    OverTimeAllowance = table.Column<TimeSpan>(type: "interval", nullable: false),
                    created_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    updated_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
                },
                constraints: table =>
