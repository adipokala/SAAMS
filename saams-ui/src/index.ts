...
import { getCompanies, createCompany, updateCompany, deleteCompany } from './api-request/company';
import { getSerialData } from './communication/serial-data'
...
// Communication
ipcMain.handle('request:getSerialData', () => getSerialData());
