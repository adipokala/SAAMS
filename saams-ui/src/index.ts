...
import { getLeaves, createLeave, deleteLeave, updateLeave, getLeave } from './api-request/leave';
import { getLeaveCounters, getLeaveCounter, createLeaveCounter, updateLeaveCounter, deleteLeaveCounter } from './api-request/leave-counter';
...
// Leave
ipcMain.handle('request:getLeaves', () => getLeaves());
ipcMain.handle('request:getLeave', (event, id) => getLeave(id));
ipcMain.handle('request:createLeave', (event, leave) => createLeave(leave));
ipcMain.handle('request:updateLeave', (event, leave) => updateLeave(leave));
ipcMain.handle('request:deleteLeave', (event, id) => deleteLeave(id));

// Leave Counter
ipcMain.handle('request:getLeaveCounters', () => getLeaveCounters());
ipcMain.handle('request:getLeaveCounter', (event, id) => getLeaveCounter(id));
ipcMain.handle('request:createLeaveCounter', (event, leaveCounter) => createLeaveCounter(leaveCounter));
ipcMain.handle('request:updateLeaveCounter', (event, leaveCounter) => updateLeaveCounter(leaveCounter));
ipcMain.handle('request:deleteLeaveCounter', (event, id) => deleteLeaveCounter(id));
