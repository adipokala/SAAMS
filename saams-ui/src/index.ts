...
ipcMain.on('set-auth', (event, authString) => {
  console.log("✅ Received auth string in main process:", authString);
  GlobalAuthManager.setAuthString(authString); // ✅ Store it globally
});
