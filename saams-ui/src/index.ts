...
import { getCompanies, createCompany, updateCompany, deleteCompany, getCompanie } from './api-request/company';
...
ipcMain.handle('request:createCompany', (event, id) => getCompanie(id));
