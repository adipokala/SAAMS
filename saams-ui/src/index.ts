...
import { createArea, deleteArea, getArea, getAreas, updateArea } from './api-request/area';
import { loginUser } from './api-request/auth';
import { createCompany, deleteCompany, getCompanies, getCompany, updateCompany } from './api-request/company';
import { createDepartment, deleteDepartment, getDepartment, getDepartments, updateDepartment } from './api-request/department';
import { createDesignation, deleteDesignation, getDesignation, getDesignations, updateDesignation } from './api-request/designation';
import { createPrivilege, deletePrivilege, getPrivilege, getPrivileges, updatePrivilege } from './api-request/privilege';
import { createRole, deleteRole, getRole, getRoles, updateRole } from './api-request/role';
import { createShift, deleteShift, getShift, getShifts, updateShift } from './api-request/shift';
import { changePassword, createUser, deleteUser, getUsers, updateUser } from './api-request/user';
...
ipcMain.handle('request:getArea', (event, id) => getArea(id));
